...
from configuration_2 import STLConfig2
from modeling_stldec_2 import STLForCausalLM
...
steps = ['step_1000', 'step_2000', 'step_3000', 'step_4000', 'step_5000']

formulae_dataset = []


for i in steps:
    model_path = f"../../../../../../../../../leonardo_scratch/fast/uTS25_Bortolus/easyskewed_512/{i}"
    optimizer_path = f"../../../../../../../../../leonardo_scratch/fast/uTS25_Bortolus/easyskewed_512/{i}/optimizer.bin"
    scheduler_path = f"../../../../../../../../../leonardo_scratch/fast/uTS25_Bortolus/easyskewed_512/{i}/scheduler.bin"

##################################################################

    AutoConfig.register("STLdec", STLConfig2)
    AutoModelForCausalLM.register(STLConfig2, STLForCausalLM)
...
eval_df.to_csv('easysk512/steps1000_5000.csv', index=False)
