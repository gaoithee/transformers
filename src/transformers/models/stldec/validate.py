...
model_path = "tf_output_test_16batch/step_28000"
optimizer_path = "tf_output_test_16batch/step_28000/optimizer.bin"
scheduler_path = "tf_output_test_16batch/step_28000/scheduler.bin"
...
eval_df.to_csv('predicted_gold_formulae_28000.csv')
eval_df = pd.read_csv('predicted_gold_formulae_28000.csv')
encoder = STLEncoder(embed_dim=1024, anchor_filename='anchor_set_1024_dim.pickle')
...
eval_df.to_csv('step_28000_formulae.csv')
