...
for i in steps:
    model_path = f"../../../../../../../../../leonardo_scratch/fast/uTS25_Bortolus/easyskewed/{i}"
    optimizer_path = f"../../../../../../../../../leonardo_scratch/fast/uTS25_Bortolus/easyskewed/{i}/optimizer.bin"
    scheduler_path = f"../../../../../../../../../leonardo_scratch/fast/uTS25_Bortolus/easyskewed/{i}/scheduler.bin"
...
eval_df.to_csv('easysk/steps16000_20000.csv', index=False)
