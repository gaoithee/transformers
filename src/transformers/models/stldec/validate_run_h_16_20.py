...
steps = ['step_16000', 'step_17000', 'step_18000', 'step_19000', 'step_20000']

formulae_dataset = []

for i in steps:
    model_path = f"../../../../../../../../../leonardo_scratch/fast/IscrC_IRA-LLMs/hardskewed_512/{i}"
    optimizer_path = f"../../../../../../../../../leonardo_scratch/fast/IscrC_IRA-LLMs/hardskewed_512/{i}/optimizer.bin"
    scheduler_path = f"../../../../../../../../../leonardo_scratch/fast/IscrC_IRA-LLMs/hardskewed_512/{i}/scheduler.bin"
...
eval_df.to_csv('hardsk512/steps16000_20000.csv', index=False)
